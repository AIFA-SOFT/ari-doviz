...
@Component({
  selector: 'app-offer-form-ui',
  templateUrl: './offer-form-ui.component.html',
  styleUrls: ['./offer-form-ui.component.scss']
})
export class OfferFormUiComponent implements OnInit {
